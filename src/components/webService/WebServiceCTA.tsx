  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute -bottom-25 -left-25 h-62.5 w-62.5 rounded-full bg-accent/6 blur-3xl" />

        {/* Subtle gold glow */}
        <div className="pointer-events-none absolute right-[12%] top-1/2 h-56 w-56 -translate-y-1/2 rounded-full bg-accent/5 blur-3xl transition-all duration-700 group-hover:bg-accent/8" />

        <div className="relative z-10 grid gap-12 lg:grid-cols-[1fr_auto] lg:items-end">
          <div>
            {/* Eyebrow */}
            <div className="mb-7 flex items-center gap-3">
              <div className="flex h-9 w-9 items-center justify-center rounded-full bg-accent/15 text-accent transition-all duration-300 group-hover:bg-accent/20">
                <Sparkles size={14} />
              </div>
        ...
        {/* Bottom gold accent */}
        <div className="absolute bottom-0 left-0 h-px w-0 bg-accent/60 transition-all duration-700 group-hover:w-full" />
      </motion.div>
    </section>
  );
}
