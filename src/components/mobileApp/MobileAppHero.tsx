  ...
  return (
    <section className="relative overflow-hidden bg-background-soft">
      ...
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute -bottom-45 -right-25 h-100 w-100 rounded-full bg-accent-soft/5 blur-3xl" />

        <div className="absolute left-[8%] top-[25%] h-px w-[84%] bg-primary/5" />

        {/* Subtle gold glow */}
        <div className="absolute right-[12%] top-[18%] h-70 w-70 rounded-full bg-accent-soft/6 blur-[100px]" />
      </div>
      ...
      <div className="relative mx-auto max-w-7xl px-5 pb-20 pt-28 md:px-8 md:pb-28 md:pt-40">
        <div className="grid items-center gap-16 lg:grid-cols-[1fr_0.85fr]">
          ...
          <div>
            ...
            >
              <span className="flex h-8 w-8 items-center justify-center rounded-full border border-accent-soft/25 bg-accent-soft/10 text-[#b99654]">
                <Smartphone size={13} />
              </span>
          ...
          >
            <div className="relative aspect-square">
              ...
              <div className="absolute inset-[15%] rounded-full border border-accent-soft/20" />

              <div className="absolute inset-[25%] rounded-full border border-primary/5" />

              {/* Gold orbit accent */}
              <div className="absolute inset-[15%] rounded-full border border-transparent border-t-accent-soft/50 rotate-[-25deg]" />
              ...
              <div className="absolute left-1/2 top-1/2 h-97.5 w-50 -translate-x-1/2 -translate-y-1/2 rounded-[38px] border-[6px] border-primary bg-primary shadow-[0_40px_100px_rgba(8,47,58,0.18)]">
                {/* Gold phone edge */}
                <div className="pointer-events-none absolute inset-[-6px] rounded-[40px] border border-accent-soft/25" />
                ...
                <div className="relative h-full overflow-hidden rounded-[30px] bg-background-soft">
                  ...
                  <div className="flex h-full flex-col px-5 pb-6 pt-12">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex h-7 w-7 items-center justify-center rounded-full bg-accent-soft text-primary">
                        <Sparkles size={11} />
                      </div>
                    </div>
                    ...
                    <div className="mt-7 rounded-2xl bg-primary p-4 text-white">
                      ...
                      <div className="mt-4 h-px w-1/2 bg-accent-soft/40" />
                    </div>

                    <div className="mt-auto grid grid-cols-3 gap-2">
                      <div className="h-12 rounded-xl bg-primary/5" />

                      <div className="h-12 rounded-xl bg-accent-soft/12" />
              ...
              {/* Floating cards */}
              <div className="absolute left-[0%] top-[25%] rounded-2xl border border-accent-soft/25 bg-white p-4 shadow-[0_20px_60px_rgba(8,47,58,0.08)] transition-transform duration-500 hover:-translate-y-1">
              ...
              <div className="absolute bottom-[20%] right-[0%] rounded-2xl border border-accent-soft/25 bg-white p-4 shadow-[0_20px_60px_rgba(8,47,58,0.08)] transition-transform duration-500 hover:-translate-y-1">
              ...
              {/* Small gold marker */}
              <div className="absolute bottom-[8%] left-[17%] h-2 w-2 rounded-full bg-accent-soft shadow-[0_0_0_6px_rgba(201,169,110,0.10)]" />
            </div>
          </motion.div>
        </div>
      </div>
