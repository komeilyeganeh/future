            ...
            <div className="relative aspect-square">
              ...
              <div className="absolute left-[8%] top-[12%] w-[84%] overflow-hidden rounded-[28px] border border-[#082f3a]/10 bg-white shadow-[0_35px_100px_rgba(8,47,58,0.12)]">
                ...
                <div className="flex items-center gap-2 border-b border-[#082f3a]/6 px-5 py-4">
                  ...
                  <div className="ml-4 h-5 flex-1 rounded-full bg-[#082f3a]/[0.035]" />
                </div>

                {/* Website preview */}
                <div className="p-5">
                  <div className="flex items-center justify-between">
                    <div className="h-3 w-20 rounded-full bg-[#082f3a]" />

                    <div className="flex gap-2">
                      <span className="h-2 w-8 rounded-full bg-[#082f3a]/10" />
                      <span className="h-2 w-8 rounded-full bg-[#082f3a]/10" />
                      <span className="h-2 w-8 rounded-full bg-[#082f3a]/10" />
                    </div>
                  </div>
                  ...
                  <div className="mt-8 grid grid-cols-[1.1fr_0.9fr] gap-5">
                    <div>
                      <div className="h-5 w-[85%] rounded-full bg-[#082f3a]/10" />
                      <div className="mt-2 h-5 w-[65%] rounded-full bg-[#082f3a]/10" />

                      <div className="mt-5 h-2 w-[90%] rounded-full bg-[#082f3a]/5" />
                      <div className="mt-2 h-2 w-[75%] rounded-full bg-[#082f3a]/5" />

                      <div className="mt-6 h-8 w-24 rounded-full bg-[#082f3a]" />
                    </div>

                    <div className="rounded-2xl bg-[#082f3a]/[0.045] p-4">
                  ...
                  <div className="mt-6 grid grid-cols-3 gap-3">
                    <div className="h-16 rounded-xl bg-[#082f3a]/[0.035]" />
                    <div className="h-16 rounded-xl bg-[#082f3a]/[0.035]" />
                    <div className="h-16 rounded-xl bg-[#082f3a]/[0.035]" />
                  </div>
                </div>
              ...
              {/* Floating cards */}
              <div className="absolute left-[0%] top-[30%] rounded-2xl border border-[#082f3a]/[0.07] bg-white p-4 shadow-[0_20px_60px_rgba(8,47,58,0.08)]">
                <Monitor size={20} className="text-[#082f3a]" />
              ...
              <div className="absolute right-[0%] top-[18%] rounded-2xl border border-[#082f3a]/[0.07] bg-white p-4 shadow-[0_20px_60px_rgba(8,47,58,0.08)]">
                <MousePointer2 size={20} className="text-[#082f3a]" />
              ...
              <div className="absolute bottom-[12%] right-[8%] rounded-2xl bg-[#082f3a] px-5 py-4 text-white shadow-[0_20px_60px_rgba(8,47,58,0.18)]">
              ...
              <div className="absolute bottom-[8%] left-[7%]">
                <p className="text-6xl font-semibold tracking-[-0.08em] text-[#082f3a]/10">
                  04
                </p>
              </div>
            </div>
