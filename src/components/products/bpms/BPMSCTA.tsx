...
export default function BPMSCTA() {
  const t = useTranslations("BPMS.cta");
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Subtle gold glow */}
        <div className="pointer-events-none absolute right-[18%] top-1/2 h-48 w-48 -translate-y-1/2 rounded-full bg-accent/[0.045] blur-3xl" />
