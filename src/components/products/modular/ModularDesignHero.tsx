        ...
        <div className="grid items-center gap-16 lg:grid-cols-[1fr_0.9fr]">
          ...
          <div>
            ...
            >
              ...
              <Link
                href="#contact"
                className="flex items-center gap-2 rounded-full border border-[#082f3a]/10 bg-white px-6 py-3.5 text-[10px] font-semibold text-primary transition-all hover:-translate-y-1"
              >
                {t("secondaryButton")}
          ...
          >
            <div className="relative aspect-square">
              ...
              <div className="absolute inset-[15%] rounded-full border border-primary/7" />
              ...
              {/* Floating cards */}
              <div className="absolute left-[1%] top-[23%] rounded-2xl border border-primary/7 bg-white p-4 shadow-[0_20px_60px_rgba(8,47,58,0.08)]">
              ...
              <div className="absolute right-[0%] top-[13%] rounded-2xl border border-primary/7 bg-white p-4 shadow-[0_20px_60px_rgba(8,47,58,0.08)]">
              ...
              <div className="absolute bottom-[15%] right-[8%] rounded-2xl border border-primary/7 bg-white p-4 shadow-[0_20px_60px_rgba(8,47,58,0.08)]">
