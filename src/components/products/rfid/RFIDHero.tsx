  ...
  return (
    <section className="relative min-h-190 overflow-hidden bg-background-soft">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute -bottom-55 -right-37.5 h-125 w-125 rounded-full bg-[#c9a86a]/[0.035] blur-3xl" />

        <div className="absolute right-[12%] top-[18%] h-48 w-48 rounded-full bg-[#c9a86a]/[0.025] blur-3xl" />
      </div>
      ...
      <div className="relative mx-auto grid min-h-190 max-w-7xl items-center gap-16 px-5 py-28 md:px-8 lg:grid-cols-[0.9fr_1.1fr]">
        ...
        >
          ...
          <motion.div
            ...
            className="absolute inset-[12%] rounded-full border border-dashed border-[#c9a86a]/20"
          />
          ...
          <motion.div
            ...
            className="absolute left-[4%] top-[27%] rounded-2xl border border-[#c9a86a]/20 bg-white p-4 shadow-[0_20px_60px_rgba(8,47,58,0.08)]"
          >
            <ScanLine size={19} className="text-[#b08d4f]" />
          ...
          <motion.div
            ...
            className="absolute right-[4%] top-[17%] rounded-2xl border border-[#c9a86a]/20 bg-white p-4 shadow-[0_20px_60px_rgba(8,47,58,0.08)]"
          >
            <Radio size={19} className="text-[#b08d4f]" />
          ...
          <motion.div
            ...
            className="absolute bottom-[13%] right-[7%] rounded-2xl border border-[#c9a86a]/20 bg-white px-5 py-4 shadow-[0_20px_60px_rgba(8,47,58,0.08)]"
          >
            ...
            <div className="mt-3 h-1.5 w-28 overflow-hidden rounded-full bg-[#c9a86a]/10">
              <motion.div
          ...
          <div className="absolute bottom-[5%] left-[8%]">
            <span className="text-6xl font-semibold tracking-[-0.08em] text-[#c9a86a]/10">
              RFID
            </span>
          </div>
        </motion.div>
