      ...
      <div className="relative mx-auto grid min-h-190 max-w-7xl items-center gap-16 px-5 py-28 md:px-8 lg:grid-cols-[0.9fr_1.1fr]">
        ...
        <div>
          ...
          <motion.h1
            ...
            className="max-w-2xl text-5xl font-semibold leading-[0.96] tracking-[-0.055em] text-[#082f3a] sm:text-6xl lg:text-7xl"
          >
            {t("title")}
            <span className="mt-2 block text-[#71838a]">
              {t("titleAccent")}
            </span>
          </motion.h1>
        ...
        >
          ...
          <motion.div
            ...
            className="absolute left-[4%] top-[27%] rounded-2xl border border-[#082f3a]/[0.07] bg-white p-4 shadow-[0_20px_60px_rgba(8,47,58,0.08)]"
          >
            <ScanLine size={19} className="text-[#082f3a]" />
          ...
          <motion.div
            ...
            className="absolute right-[4%] top-[17%] rounded-2xl border border-[#082f3a]/[0.07] bg-white p-4 shadow-[0_20px_60px_rgba(8,47,58,0.08)]"
          >
            <Radio size={19} className="text-[#082f3a]" />
          ...
          <motion.div
            ...
            className="absolute bottom-[13%] right-[7%] rounded-2xl border border-[#082f3a]/[0.07] bg-white px-5 py-4 shadow-[0_20px_60px_rgba(8,47,58,0.08)]"
          >
            ...
            <div className="mt-3 h-1.5 w-28 overflow-hidden rounded-full bg-[#082f3a]/10">
              <motion.div
