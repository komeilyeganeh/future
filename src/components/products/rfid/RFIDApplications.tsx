            ...
            {applications.map((item, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="group rounded-[26px] border border-primary/7 p-6 transition-all duration-300 hover:-translate-y-1 hover:bg-background-soft"
                >
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-[9px] font-semibold tracking-[0.2em] text-primary/20">
                      0{index + 1}
                    </span>
                  </div>
