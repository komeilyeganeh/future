  ...
  return (
    <section className="relative overflow-hidden bg-[#f8faf9]">
      <div className="absolute inset-0">
        ...
        <div className="absolute right-[-120px] top-1/3 h-[320px] w-[320px] rounded-full bg-[#082f3a]/[0.02] blur-3xl" />
      </div>
        ...
        <div className="grid items-center gap-16 lg:grid-cols-[1.05fr_0.95fr]">
          ...
          >
            <div className="relative aspect-square">
              ...
              <div className="absolute inset-[38%] rounded-full bg-[#082f3a] shadow-[0_30px_100px_rgba(8,47,58,0.2)]">
              ...
              <div className="absolute right-[0%] top-[12%] rounded-2xl border border-[#082f3a]/[0.07] bg-white p-4 shadow-[0_20px_60px_rgba(8,47,58,0.08)]">
                <Cpu size={20} className="text-[#082f3a]" />
              ...
              <div className="absolute bottom-[15%] right-[7%] rounded-2xl border border-[#082f3a]/[0.07] bg-white p-4 shadow-[0_20px_60px_rgba(8,47,58,0.08)]">
