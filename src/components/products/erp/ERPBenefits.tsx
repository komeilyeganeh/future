          ...
          <div className="space-y-3">
            {benefits.map((benefit, index) => (
              <motion.div
                ...
                className="group flex items-center justify-between rounded-[22px] border border-[#082f3a]/[0.07] px-6 py-5 transition-all hover:border-[#082f3a]/15 hover:bg-[#f8faf9]"
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-sm font-semibold text-[#082f3a]">
                      {t(`items.${benefit}.title`)}
                    </h3>

                    <p className="mt-1 text-xs text-[#71838a]">
                ...
                <ArrowUpRight
                  size={16}
                  className="text-[#082f3a]/20 transition-transform group-hover:translate-x-1 group-hover:-translate-y-1"
                />
              </motion.div>
            ))}
          </div>
