...
export default function CareersJobs() {
  ...
  return (
    <section id="jobs" className="relative overflow-hidden bg-background-soft">
      {/* Ambient gold glow */}
      <div className="pointer-events-none absolute -right-40 top-1/3 h-100 w-100 rounded-full bg-[#d6ad55]/3 blur-[120px]" />
      ...
      <div className="relative mx-auto max-w-7xl px-5 py-24 md:px-8 md:py-32">
        ...
        >
          <div className="flex items-center gap-3">
            <span className="h-px w-8 bg-[#d6ad55]" />
        ...
        <div className="mt-14 overflow-hidden rounded-[30px] border border-primary/7 bg-white shadow-[0_20px_70px_rgba(8,47,58,.035)]">
          {jobs.map((job, index) => (
            ...
            >
              ...
              <div className="pointer-events-none absolute inset-0 bg-linear-to-r from-[#d6ad55]/0 via-[#d6ad55]/0 to-[#d6ad55]/0 opacity-0 transition-all duration-500 group-hover:from-[#d6ad55]/2 group-hover:via-[#d6ad55]/1 group-hover:opacity-100" />

              {/* Gold bottom line */}
              <div className="pointer-events-none absolute bottom-0 left-0 h-px w-0 bg-linear-to-r from-[#d6ad55] via-[#d6ad55]/50 to-transparent transition-all duration-700 group-hover:w-full" />

              <div className="relative z-10 flex items-start gap-6">
                {/* Number */}
                <span className="pt-1 text-[10px] font-semibold tracking-[0.2em] text-secondary transition-colors duration-300 group-hover:text-[#d6ad55]">
                  {job.number}
                </span>
                ...
                <div>
                  ...
                  <div className="mt-3 flex flex-wrap gap-4">
                    <span className="flex items-center gap-1.5 text-[10px] font-medium text-secondary transition-colors duration-300 group-hover:text-primary">
                      <MapPin
                        size={12}
                        className="transition-colors duration-300 group-hover:text-[#d6ad55]"
                      />
              ...
              {/* Arrow */}
              <div className="relative z-10 flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-primary text-white transition-all duration-300 group-hover:rotate-45 group-hover:bg-[#d6ad55] group-hover:text-primary group-hover:shadow-[0_8px_25px_rgba(214,173,85,.22)]">
        ...
        >
          <span className="h-1.5 w-1.5 rounded-full bg-[#d6ad55] shadow-[0_0_10px_rgba(214,173,85,.45)]" />
